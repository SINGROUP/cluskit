...
def get_soap_locals(obj, Hpos, alp, bet, rCut=5.0, NradBas=5, Lmax=5, crossOver=True, all_atomtypes=[]):
    ...
    assert rCutHard < 30.0001 , "hard redius cuttof cannot be larger than 17 Angs. rCut={}".format(rCutHard)
    ...
    assert NradBas <= 25 , "number of basis functions cannot exceed 12. NradBas={}".format(NradBas)
